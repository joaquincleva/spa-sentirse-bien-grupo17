...
import { serviceEditNewsId } from "@/services/news.service";
import { useToast } from "@/hooks/use-toast";

interface EditNewsProps {
  setEditMode: (arg: boolean) => void;
  noticia: News | null;
  setNoticia: (arg: News) => void;
}
...
const EditNewsForm = ({
  ...
  const initialValues = {
    ...
    publish_date: noticia?.publish_date,
  };
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      try {
        await serviceEditNewsId(noticia?.id ?? "", noticiaAModificar);
